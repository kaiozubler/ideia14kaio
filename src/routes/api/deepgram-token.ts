...
// Extraído para função reutilizável: tanto a rota interna (/api/deepgram-token,
// usada pelo app principal) quanto a rota pública da extensão de navegador
// (/api/public/extensao/deepgram-token) precisam do mesmo fluxo de emissão de
// token efêmero do Deepgram.
export async function issueDeepgramToken(): Promise<Response> {
